...
export class Impresora {
  ...
  async imprimirCaja(calaixFet, nombreTrabajador, descuadre, nClientes, recaudado, arrayMovimientos: any[], nombreTienda, fI, fF, cInicioCaja, cFinalCaja,totalDatafono3G,detalleApertura,detalleCierre, tipoImpresora) {
    console.log(detalleApertura[0]['valor'])
    try {
      ...
      device.open(function() {
        printer
            ...
            .text('')
            .text('')
            .text('0.01--> ' +detalleApertura[0]['valor'] +'   ' + '0.01--> ' +detalleCierre[0]['valor'] )
            .text('0.02--> ' +detalleApertura[1]['valor'] +'   ' + '0.02--> ' +detalleCierre[1]['valor'] )
            .text('0.05--> ' +detalleApertura[2]['valor'] +'   ' + '0.05--> ' +detalleCierre[2]['valor'] )
            .text('0.10--> ' +detalleApertura[3]['valor'] +'   ' + '0.10--> ' +detalleCierre[3]['valor'] )
            .text('0.20--> ' +detalleApertura[4]['valor'] +'   ' + '0.20--> ' +detalleCierre[4]['valor'] )
            .text('0.50--> ' +detalleApertura[5]['valor'] +'   ' + '0.50--> ' +detalleCierre[5]['valor'] )
            .text('1.00--> ' +detalleApertura[6]['valor'] +'   ' + '1.00--> ' +detalleCierre[6]['valor'] )
            .text('2.00--> ' +detalleApertura[7]['valor'] +'   ' + '2.00--> ' +detalleCierre[7]['valor'] )
            .text('5.00--> ' +detalleApertura[8]['valor'] +'   ' + '5.00--> ' +detalleCierre[8]['valor'] )
            .text('10.00--> ' +detalleApertura[9]['valor'] +'   ' + '10.00--> ' +detalleCierre[9]['valor'] )
            .text('20.00--> ' +detalleApertura[10]['valor'] +'   ' + '20.00--> ' +detalleCierre[10]['valor'] )
            .text('50.00--> ' +detalleApertura[11]['valor'] +'   ' + '50.00--> ' +detalleCierre[11]['valor'] )
            .text('100.00--> ' +detalleApertura[12]['valor'] +'   ' + '100.00--> ' +detalleCierre[12]['valor'] )
            .text('200.00--> ' +detalleApertura[13]['valor'] +'   ' + '200.00--> ' +detalleCierre[13]['valor'] )
            .text('500.00--> ' +detalleApertura[14]['valor'] +'   ' + '500.00--> ' +detalleCierre[14]['valor'] )
            .cut()
            .close();
      });
    } catch (err) {
